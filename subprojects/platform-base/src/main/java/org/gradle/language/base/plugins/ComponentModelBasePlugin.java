...
public class ComponentModelBasePlugin implements Plugin<Project> {
    ...
    static class PluginRules extends RuleSource {
        ...
        @Defaults @Each @Transitive
        void initializeComponentSourceSets(ComponentSpecInternal component, LanguageSourceSetFactory languageSourceSetFactory, LanguageTransformContainer languageTransforms) {
        ...
        @Finalize @Each @Transitive
        void applyDefaultSourceConventions(LanguageSourceSet languageSourceSet, ProjectIdentifier projectIdentifier) {
        ...
        @Finalize @Each @Transitive
        void addSourcesSetsToProjectSourceSet(LanguageSourceSet languageSourceSet, final ProjectSourceSet projectSourceSet) {
